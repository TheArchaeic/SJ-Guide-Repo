...
## Pre-Early Game: Picking Your Class
...
- SK DPS
	- Pros: High Burst Damage, Less "Focus" Stats on gear (HP, Basic Attribute, Skill Flat/Skill %), Seal grinding is not as necessary for early/mid game, High potential for "skipping" boss mechanics
...
- AA DPS
	- Pros: Consistent Damage across the board, Access to the 'Guardian' Memory Skill (aka free damage reduction of up to 20%) [Not Applicable from Pied onwards], Overall easier Deck Progression, Very little position lock so easy maneuverability for boss mechanics
	- Cons: Cannot skip without high damage, More "Focus" stats on gear (Basic Attribute, Critical Damage, Hit Rate, Attack, Critical [If severely lacking]) means a sacrifice on HP otherwise lowering total damage

And with that comes the final question: You want to play as X class, so what tamer and partner digimon should you pick?  
- If you decide to play as a SK DPS, unfortunately your early game tamer doesn't matter. However, I recommend Yoshino due to her tamer skill (Protection) being a 'Get-Out-Of-Big-Damage-Free' Card and may prove useful. As a starter, you should choose Gaomon. 
- If you decide to run as an AA DPS, you should run Keenan Crier as your first Tamer. His Tamer Skill, "Shock", gives a Critical Damage increase that'll prove strong as an early game AA. For your digimon partner, you'll want to pick Rosemon.
- If you want to go as a Tank, you should go for Yoshino. As mentioned prior, her Protection skill is an indispensible tool for any class, however as a tank even moreso due to the HP check mechanics that are often thrown your way (Also known as 'Tank Busters'). There's also the added bonus of a 10% base defense increase due to her passive skills. As far as starters go, none of them benefit the tank class, thus you can freely choose any of them. Once you've finished the tutorial, you will have no reason to keep using them as you will receive your first real Tank digimon at that point.

Once you've selected your tamer and partner, you're officially ready to start your journey.

## Pre-Early Game: Tutorial
...
- 1 Growth Fruit[Savers]
	- Growth Fruits automatically re-size the Digimon they're used on to 125%. The Digimon Size % determines the base stats of the digimon. For example, at 90% size, they have 90% of their base stats. While Starter Digimon normally cannot be re-sized, this special growth fruit can modify their size, giving them access to the Transcendence mechanic.
...
- A Gift Package corresponding to the Digimon's class
	- This package contains a lot of items that'll help you get through the slog of early game, such as 7 day Tamer Skills, Transcendence Fruits, a Mercenary Slot Expansion, Mega Reinforced DigiClones, a Tamer Exchange item for one of your class's useful Tamers, a starting Digivce for your class and more. While you should still open the package to make use of some of the items, such as the Digivice and the Expansion items, a majority of these items are effectively *useless* to you until you can run dungeons, as that is where you will be able to make the most use out of them.
...
- 10 Digimon Enhancement Buff Package [NEW] (Wait, we have buffs??)
	- As a standard expectation of DMW dungeon running, we have 3 2 hour buffs obtained from this package (and other sources).
...
- Use as many Jumping Crystals [Digimon] as needed to promote your starter to Level 70, then utilize the SSS unlock item for a big and easy stat boost.
	- Reminder: Aspiring Tanks should hold onto these and use them on V-mon [Vengeful]/Icy to get him as high a level as possible.
...
- Spend the remaining Jumping Crystals on your new Digimon which should push them to Level 70+
	- If you chose LordKnightmon X or IcyMagnamon X, do not use the 30D XAI just yet. As tempting as it may be, you will want to save access to the XAI for when you can make optimal use of it. Later on, you will be able to get a worse, but permanent, version of the XAI.
...
- Continue with the File Island Questline that Elecmon teleports you to start at the Village of the Beginning. These quests give generally high experience that'll push your starter digimon to 90+ quite easily. Hold off on progressing to Server Continent, for now.
...
- Backtrack and complete the Glacier Area questline started by "Miki's Summons". While being one of the largest sets of quests, the area completion rewards make it worth it. Once you fully complete it, again backtrack and head to the Western Area.
	...
	- By the end of the Glacier Questline, you should have all of Tsunomon's quests complete and move onto Gabumon's. At this point, you should have at least 15 Challenge Coins.
		- Head back to DMW Village and behind the Novice Challenge NPCs, you should find a Taichi NPC. Talk to him and exchange 15 Challenge Coins for the digiegg of the remaining starter digimon for your class in the DigiEgg Exchange:
			- AA: ShineGreymon
			- SK: Falcomon
			- TA: Don't worry about getting the second starter. Instead, trade for BM DigiEgg/Jogress DigiEgg Exchange Tickets and get the eggs required for your decks.
...
- If you haven't already, continue on from File island to the Server Continent questline. This questline is pretty straightforward and should be pretty easy to complete with a level 100+ Digimon. By the end of this questline, either your first starter or your journey digimon (potentially both) should be level 120 or close to.
	- Once you're at the Server Continent Pyramid map, you can start the farm for Susanoomon. For AA, this is the VA SSS that can complete your trifecta, if you don't want to use ShineGreymon Golden. For SK and TA, getting Susanoomon is just a stepping stone/pre-requisite for a later digi required: Susanoomon Shin. For SK, Susanoomon Shin is the F2P VA SSS+ Option you'll likely have to use. For TA, Susanoomon Shin is a requirement for your decks.
...
- You can continue questing as you still have several questlines to begin and complete:
	- "A call" - This quest appears on your digivice when your digimon is level 100+. This will take you to Shinjuku which provides a lot of high experience quests, which is perfect for getting the second starter digimon boosted to Level 120. After finishing the Shinjuku Area, you can start the Digital Area questline.
		- With access to the Digital Area maps, you can also start the grind for your [Goggles](https://digitalmastersworld.wiki.gg/wiki/Goggles), which give you a decent boost to your damage, but costs a grand total of 150T for max level. As an AA DPS, you'll want the AT/AT goggles. As a SK DPS, you'll want SK/SK. As a TA, you'll want DE/DE.
	- "Anomalies are Detected, Investigation Required" - Richard Sampson should have this quest that'll direct you to the Versandi Terminal map and start the questline there. Be warned, the map does have an X-Program debuff that causes DoT and decreases digimon damage. The only methods to dispel this debuff is for the Omegamon Raid in Versandi to be killed, giving a damage buff that overwrites the debuff across the entire map, using an X-Digimon, or using an X-Protector item.
		- If you have LordKnightmon X/IcyMagnamon X as your journey digimon and plan to quest here, it is a worthwhile reason to use the 30D XAI you were given earlier. One of the later side quests gives a permanent XAI, giving you free access to the X-Antibody evolutions (As long as you have X-Antibody items to fill it with)
...
- The [Tamer System](https://digitalmastersworld.wiki.gg/wiki/Tamer_system) can be split up into 3 separate sections: Tamer Cosmetics, Tamer Passive Skills, and Tamer Skills
	- Tamer Cosmetics -
		...
		- You can also buy Tamer Coins from the Cash Shop to exchange for skins on certain tamers, such as the DATS Uniform for Marcus or the Summer Outfit for Yoshida at the Babel NPC at DATS.
	...
	- Recommended Combinations for high DPS:
		- For SK -
  			- Early/Mid Game: Matt Passives, Enhanced/Ultimate Vigor, Reinforced/Ultimate Focus **OR** Reinforced/Ultimate Saikyou
  			- End Game: Matt Passives, Enhanced/Ultimate Vigor, Reinforced/Ultimate Encouragement **OR** Reinforced/Ultimate Pray
		- For AA - 
  			- Early/Mid Game: Ruli Passives (if needing HT) **OR** Keenan Passives, Enhanced/Ultimate Berserker, Enhanced/Ultimate Analysis
  			- End Game: Ruli Passives (if needing HT) **OR** Keenan Passives, Enhanced/Ultimate Berserker, Reinforced/Ultimate Encouragement **OR** Reinforced/Ultimate Pray
		- For TA - 
  			- Early/Mid Game: Kiyoshiro Passives OR T.K. Passives OR Yoshino Passives, Enhanced/Ultimate Protection, Enhanced/Ultimate Integer Overflow OR Enhanced/Ultimate Cheer
  			- End Game: T.K. Passives OR Yoshino Passives, Enhanced/Ultimate Protection, Enhanced/Ultimate Emergency OR Enhanced/Ultimate Cheer
...
- Each class has a different "perfect" set of options on accessories for maximum damage.
	...
	- For SK DPS:
    	<details>
		<summary>Pre-Spiral Gear</summary>
		...
		*Note: All Skill rolls on gear can be swapped for Max HP, if possible. Skill Flat is a weak stat, especially on non-Spiral Gear.
		...
		<details>
		<summary>Spiral/Corrupted Gear</summary>
			
		- Earring - Skill%, Skill%, Basic Attribute, Basic Attribute, Max HP
		- Necklace - Skill%, Skill%, Basic Attribute, Basic Attribute, Attack Speed/Max HP/Max DS
		- Bracelet - Skill%, Skill%, SK Flat/Max DS, Max Hp, Max HP
		- Ring - Skill%, Skill%, Basic Attribute, Basic Attribute, Max HP/Skill Flat
	...
	- For AA DPS:
		...
		- Earring - Critical Damage, Basic Attribute, basic Attribute, Attack, Max HP
		- Necklace - Attack, Attack Speed, Basic Attribute, Basic Attribute, Max HP
		- Bracelet - Critical Damage, Hit Rate, Attack, Skill%/Max HP, Max HP
		- Ring - Attack, Attack, Basic Attribute, Basic Attribute, Critical Damage
	...
	- For TA
		...
		- Earring - Max HP, Max HP, Block, Avoid
		- Necklace - Max HP, Max HP, Max HP, Attack Speed
		- Bracelet - Depends:
				- Royal : X-Knight Bracelet/Miracle Bracelet - Max HP, Max HP, Avoid, Avoid, Defense
				- Royal : Yggdrasil Bracelet - Max HP, Max HP, Block, Avoid, Defense
		- Ring - Max HP, Max HP, Max HP, Defense
		...
		- Earring - Max HP%, Max HP%, Defense%, Defense%, Block
		- Necklace - Max HP%, Max HP%, Defense%, Defense%, Block
		- Bracelet - Max HP%, Max HP%, Defense%, Defense%, Block
		- Ring - Max HP%, Max HP%, Defense%, Defense%, Avoid
...
### Memory Skills
- Memory Skills are extra skills that can be added to a digimon evolution, granting them unique effects. They are optional in the early game, but practically mandatory in midgame and beyond.
...
- They are split into 3 Groups: Offensive, Defensive and Support skills
	- Offensive Skills can be sub-classed into 2 broad groups: "Rulers" and "Emperors"
		...
		- Outside of the Rulers and Emperors, there also exists "Last Effort", but unfortunately due to the strict conditions of the Skill, it is a very situational Memory Skill to have and use.
...
- When it comes to the question of "What Memory Skills should I put on my digimon?", it largely depends on the class and use case.
	...
	- For AA -
		- A corresponding Guardian to the Digimon's Element
			...
			- From the Back of the Empire Dungeon onwards, it is worth to swap for an Emperor instead. Post-Mugen DG content has mechanics that can break through guardian, making it useless for DPS digimon.
		- Tree of Life (For Max HP and Max DS increase) or Hand of Healing (for group healing)
  	- For TA -
  		- A corresponding Guardian to the Digimon's Element
  	 		- You can similarly opt for a "Defender" instead of a Guardian due to the generally lower price compared to a Guardian. Provocation is also an option, however it does trigger an auto attack animation and can cause potential deaths/misplays.
  	   - Regenerative Ability. Unlike the two DPS classes, it is most important the Tank stays alive, thus should be more selfish with their Memory Skills.
...
- (Optional, but recommended) Start running [Digimon Arena](https://digitalmastersworld.wiki.gg/wiki/Digimon_Arena) Normal Difficulty (Colosseum/Colo)
	...
	- There are 10 rounds.
		- Rounds 1-4 are the Odaiba Raid boss pairs. Focus on one first then target the other. Do not try to kill both at the same time.
...
- SK DPS - Obtain Ogudomon (and complete your SSS Digimon trifecta).
	- If you want to do it fully F2P, you will need to collect 1 of each of the Seven Great Demon Lords and level them to 120. At 120, they will each unlock a one-time quest from White-bearded Guru NPC at DATS.
	- Once you obtain the Source of Sin item from the quest, you can convert the Demon Lord digimon into one of 7 items necessary to hatch Ogudomon.
  		- If you can't or do not wish to complete any of the quests, the Source of Sin items are available in the Cash Shop for 99 crown or you can buy the converted demon lord items from other players.
			- If you buy the Source of Sin items from the Cash Shop, you will need to convert them from Non-Character Bound to their Character Bound versions at the Digitamamon NPC at DATS.
- AA DPS/Tank - Obtain Shoutmon DX
	- While this may seem like an "out of the way" step, Shoutmon DX is a necessary digimon for both classes.
		- For AA, DX is a required step for Shoutmon X7, the F2P AA Data SSS+.
		- For Tank, DX is both the F2P Data SSS Tank and a requirement for BlackShoutmon X7, the F2P Data SSS+ Tank.
  	- To Obtain Shoutmon DX, you need Shoutmon, Greymon (C) and Mailbirdramon. All 3 digieggs are obtainable from GreenZone Advanced. The OmegaShout item is obtainable from GreenZone NightSky.
  	- For the Evolution Items, you must obtain the Gold Digizoid Data from the Crusade Mode quests given by the Pickmon NPC in D-Terminal.
  		- It takes 3 Gold Digizoid Data to craft the Alpha and beta parts, for a total of 6 Gold Digizoid Data.
- Farm the Hard Holy Beast Dungeons/SSS Holy Beast Dungeons for Holy Beast/Radiant Holy Beast gear:
	- AA DPS/Tank - It is technically possible to skip this step and move on straight to Fang gear. For AA players however, it is highly unrecommended.
	- The Hard and SSS dungeons have different drops from the normal difficulty dungeons as well as a health increase on the bosses.
		...
		- Qinglongmon drops all 3 Radiant Qing gear due to being used to upgrade the Lv.5 Holy Beast gear into Lv.5 Radiant Holy Beast gear. It also has a much higher crystal drop rate due to needing more crystals.
...
- Once you've acquired Radiant Holy Beast gear at Semi-Perfect, you should begin farming [Royal Base [Normal]](https://digitalmastersworld.wiki.gg/wiki/Royal_Base) (RBN) for the Royal : X-Knight Bracelet.
  	- **Recommended Gear**: Radiant Four Holy Beast Lv.5 Gear + Underworld Bracelet (if still Active)
	...
	- As long as you are not using an X-Antibody Digimon (such as Craniamon X), you will need X-Protector items otherwise you will be hit with the X-Program debuff and have your damage and survivability halved. X-Protectors are obtainable from some Sub Quests/Daily Quests in Versandi Terminal.
...
- Decks:
	- AA DPS: 'Our Final Evolution'
 	- SK DPS: 'Forsaken Strain'
  	- TA: 'Seafood Stew/Iron Thronefall'
...
- Run [Digimon Arena Hero Mode](https://digitalmastersworld.wiki.gg/wiki/Digimon_Arena#Round_Rewards_Colosseum_Hero_Mode/Extreme_Mode) (Colo Hero)
	- **Recommended Gear:** Radiant Four Holy Beast Lv.5 Gear + Royal : X-Knight Bracelet  
	- Unlike Colo Normal Mode, Hero is 6 rounds of more mechanic-heavy bosses. You also do not lose points upon failure, making it worthwhile to always check if you can clear the next round. Talk to the Dux NPC to start the Hero difficulty.
	- Ensure your digimon 'trifecta' are fully leveled and cloned. You will need a VA, DA and Vi Digimon to complete Colo Hero.
	- As you complete each round, you will receive Boxes that contain Ranking Points and Supreme Evolution Summon Cards (v1 and v2).
	...
	<details>
	<summary>Round Mechanics</summary>
		
	- Round 1, Millenniummon, mainly casts different meteor circles and has a special mechanic at 30%
	...
	- Round 2 through 4 have simple mechanics again, but hit much harder than the previous rounds.
		- If you do not have the HP and or DE to take a hit, it may be worth having a tank in your party.
	- **Round 5 and 6 require a Tank. Without a Tank, you will all drop like flies at this level of progression.**
	- Round 5, Examon X, has a field effect during his round: All players take 200 DoT until he is defeated.
	...
	- Round 6, Ordinemon, also has a field effect during her round: Block is reduced.
...
- True Digivice (guide here) requires that you farm Tokyo-Odaiba raid bosses for the materials they can drop.
    - Instead of farming the raid bosses, you can also do the Rainbow Bridge dungeon for the Powder of Evolution item. With 2 Powder of Evolution, you can craft 1 of any raid boss material.
    - At a certain level of craft, you will need to start doing the Tokyo-Odaiba dungeons, Tokyo Tower Observatory, Fuji TV Rooftop, and Venomous Vortex.
    	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + Royal Digivice [SK]/D-Ark v1 [AA/Tank]
     	- **Recommended Clothing:** Any
    ...
    - If you do not want to do all of them individually, you can take the Tokyo Tokens gained from clearing the dungeons to the Hikari NPC in Odaiba. You can craft the dungeon materials at a cost of 10 tokens.
- Once you've acquired the True Digivice and have all 3 SSS+, you can start doing the True Digivice (Advanced) grind.
    - You will need to run the Path of Bravery, Path of Friendship and Venomous Vortex (Hard) dungeons. These dungeons all require a tank.
    	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + True Digivice [SK]/D-Ark v5 [AA/Tank]
     	- **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Any [Tank]
        - The dungeons drop 2 of the required materials per clear, 1 non-Character Bound and 1 Character Bound.
...
<details>
<summary>For AA DPS/Tanks</summary>

- Both Tanks and AA DPS benefit the most from the D-Ark and it's upgrades, the Rage/Digizoid D-Ark and Uncontrollable Rage/ChromeDigizoid D-Ark. D-Ark Guide here
   - While Tanks don't benefit as much from D-Ark v1 to v5 compared to AA DPS, it is still a necessary step to obtain the Digizoid D-Ark and ChromeDigizoid D-Ark
- For D-Ark Lv1 to Lv5, you must complete the Vajramon Hard/SSS and Vikaralamon Hard/SSS dungeons. Each successful clear gives you the required materials for the D-Ark upgrades. Due to the balancing on these dungeons, you do not need an SSS+. However, for the DPS classes, many parties expect a SSS+ for the Hard versions.
    - Each Hard dungeon clear gives you 30 Character Bound materials and 5 non-Character Bound materials. SSS gives 40 Character Bound materials.
    	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + Royal Digivice [SK]/D-Ark v1 [AA/Tank]
     	- **Recommended Clothing:** Any	
        - (Hard) If you choose to sell the non-Character Bound materials, you need 72 runs of each dungeon, or 144 total runs.
        - (Hard) If you choose to keep and convert the non-Character Bound materials, you only need 62 runs of each dungeon, or 124 total runs.
        - (SSS) If you do the SSS version of the dungeons, you only need 54 runs of each dungeon, or 108 total runs.
...
- After getting BloomLordmon and acquiring the D-Ark Lv5, you'll be well equipped enough to take on the Digital Area dungeons for the Rage and Uncontrollable Rage D-Ark upgrades. These dungeons all require a tank.
    ...
    - Burning Battle Field
    	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + Royal Digivice [SK]/D-Ark v5 [AA/Tank]
     	- **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Any [Tank]
        - AA DPS - You will need 300 total materials for both upgrades. If you keep and convert the non-CB items, you only have to run the dungeon 60 total times. If you choose to sell the non-CB items, you will need 100 total dungeon runs.
        - Tank - You will need 150 total materials for both upgrades. If you keep and convert the non-CB items, you only have to run the dungeon 30 total times. If you choose to sell the non-CB items, you will need 50 total dungeon runs.
    - Chaotic Battle Field
    	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + Royal Digivice [SK]/D-Ark v5 [AA/Tank]
     	- **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Any [Tank]
        - AA DPS - You will need 150 total materials for both upgrades. If you keep and convert the non-CB items, you only have to run the dungeon 30 total times. If you choose to sell the non-CB items, you will need 50 total dungeon runs.
        - Tank - You will need 300 total materials for both upgrades. If you keep and convert the non-CB items, you only have to run the dungeon 60 total times. If you choose to sell the non-CB items, you will need 100 total dungeon runs.
    - Final Battle
    	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + Royal Digivice [SK]/Rage D-Ark [AA]/Digizoid D-Ark [Tank]
     	- **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Any [Tank]
        - You will need 200 total materials for both upgrades. If you keep and convert the non-CB items, you only have to run the dungeon 40 total times. If you choose to sell the non-CB items, you will need 67 total dungeon runs.
...
- The majority of your clothing (5 out of 6 pieces) comes from the GreenZone NightSky guild dungeon. It has an 8 player capacity, but can only be done with guild members.
  	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : X-Knight Bracelet + Royal Digivice [SK]/D-Ark v1 [AA/Tank]
  	- **Recommended Clothing:** Any
    - You will need to acquire the Starmon's Ornament, Shoutmon's Cape, Dorulumon's Pants, Balistamon's Gloves and Sparrowmon's Shoes. These are non-CB and can be bought from other players as well.
        - You can also "pity" for them via the Crusade Mode quests from the Pickmon NPC in D-Terminal. Each clothing item costs 30 Gold Digizoid Data for a grand total of 150 Gold Digizoid Data.
 ...
 - Your Clothes should look as follows:
    ...
    - Top - Rare Coin Top/Swiming Gears - Life Vest/Back to School [Formal Robe]/Spooky Soulmon's Robe/Agumon Top
   		- While the Rare Coin Top is ideal, it is a rare item that is otherwise not that required for max DPS. The Spooky Soulmon's Robe and Agumon Top are generally obtainable as event rewards. However, the Agumon Top is buyable from the Cash Shop (via the Agumon Clothing Set)
...
- The majority of your clothing (4 out of 6 pieces) comes from the Vajramon Hard/SSS dungeon.
    - You will need the Warrior Ornament, Warrior Top, Warrior Pants and Warrior Gloves, specifically the Shining Variant.
        - If you complete the SSS Dungeon, there is a chance to drop a Character Bound variant. These clothes do not mix with the non-Character Bound variant bought from other players/dropped from Vajramon Hard.
...
- Your Clothes should look as follows:
    ...
    - Shoes - Satan Shoes/Sparrowmon's Shoes/Any 2-slot 30% MS Shoes
        - As mentioned in the SK Clothing section, Sparrowmon's Shoes come from Greenzone NightSky, an 8-player guild dungeon.
        - Satan Shoes come from Infinite Mountain Dungeon 2.0, a 12-player guild dungeon.
...
- The majority of your clothing (5 out of 6 pieces) comes from the Burning Battle Field dungeon.
    - You will need the Digital Hazard Cap, Digital Hazard Cape, Digital Hazard Shirt, Digital Hazard Pants, and Digital Hazard Gloves.
    - When these 5 pieces are worn together, you gain a set bonus:
        - Damage Reduction 1% per 5000 DE
      	- Skill Damage 1% per 2000 DE
        - Critical Damage 1% per 1000 DE
- Your Clothes should look as follows:
    - Head - Digital Hazard Cap
    - Fashion - Digital Hazard Cape
    - Top - Digital Hazard Shirt
    - Bottom - Digital Hazard Pants
    - Gloves - Digital Hazard Gloves
    - Shoes - Satan Shoes/Sparrowmon's Shoes/Any 2-slot 30% MS Shoes
        - While Satan Shoes are arguably the "best" for Tanks due to the Defense bonus, 400 DE is such a negligible amount that any shoes will do.
        - As mentioned in the SK Clothing section, Sparrowmon's Shoes come from Greenzone NightSky, an 8-player guild dungeon.
        - As mentioned in the AA Clothing section, Satan Shoes come from Infinite Mountain Dungeon 2.0, a 12-player guild dungeon.
...
- Royal Base [[Hard]](https://digitalmastersworld.wiki.gg/wiki/Royal_Base_Hard) (RBH)
	...
	- This dungeon drops all the required materials for the Royal : Yggdrasil Bracelet. For SK, this upgrade is very miniscule however, for TK and AA, it is a pretty noticeable increase. The Ultimate Upgrade for the Yggdrasil Bracelet is also a requirement for the Clown Bracelet of the Spiral Gear set.
	- Each clear rewards 1 Yggdrasil Core.
<details>
<summary>Room Mechanics</summary>
	...
	- Room 1 has Examon X, Gankoomon X and Jesmon X. They are fought in a random order.
        ...
        - Jesmon X - Note-Worthy Mechanics:
      		- @ 90% - Summons Portals (50s CD) "Portal Incoming"
    			- The Portals have extremely high Damage Reduction and require Damage Over Time (DoT) damage to kill them, such as Lilithmon X's F1 effect or Megidramon X's F1 effect. Final Damage buffs such as UlforceVeedramon Future Mode's F2 effect or BlackShoutmon X7's F1 effect also work as the added Final Damage bypasses Damage Reduction.
	...
	- Room 3 has two bosses: Dexmon, Alphamon then Alphamon Ouryuken Awaken
		...
		- Alphamon Ouryuken Awaken - Note-Worthy Mechanics:
			...
			- @ 50% - Green Circle
				...
				- Ensure you do not make an attempt to skip the Green Circle. If you do
			- @ 30% - Stack -> Split -> Stack
...
- [Marine Dragon Domain](https://digitalmastersworld.wiki.gg/wiki/Marine_Dragon_Domain) (MDG)
  	- **Recommended Gear**: Fanglongmon's Ancient Gear Lv.10 + Royal : Yggdrasil Bracelet + Advanced True Digivice [SK]/Uncontrollable Rage D-Ark [AA]/ChromeDigizoid D-Ark [Tank]
    - **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Digital Hazard Clothing Set [Tank]
	- The first of the 7 Spiral Mountain dungeons.
...
- [Front Yard of Marionette Mansion](https://digitalmastersworld.wiki.gg/wiki/Front_Yard_of_Marionette_Mansion) (PDG)
  	- **Recommended Gear**: Ring of the Marine Dragon + Fanglongmon's Ancient Gear Lv.10 + Royal : Yggdrasil Bracelet + Advanced True Digivice [SK]/Uncontrollable Rage D-Ark [AA]/ChromeDigizoid D-Ark [Tank]
    - **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Digital Hazard Clothing Set [Tank]
	- The second of the 7 Spiral Mountain dungeons.
...
- [Back of the Empire](https://digitalmastersworld.wiki.gg/wiki/Back_of_the_Empire) (Mugen DG)
  	- **Recommended Gear**: Ring of the Marine Dragon + Necklace of the Wooden Puppet + Fanglongmon's Ancient Earring Lv.10 + Royal : Yggdrasil Bracelet + Advanced True Digivice [SK]/Uncontrollable Rage D-Ark [AA]/ChromeDigizoid D-Ark [Tank]
    - **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Digital Hazard Clothing Set [Tank]
...
- [Four Pillars of Ruin](https://digitalmastersworld.wiki.gg/Four_Pillars_of_Ruin)
  	- **Recommended Gear**: Ring of the Marine Dragon + Necklace of the Wooden Puppet + Earring of the Metallic Beast + Bracelet of the Cruel Clown + Advanced True Digivice [SK]/Uncontrollable Rage D-Ark [AA]/ChromeDigizoid D-Ark [Tank]
    - **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Digital Hazard Clothing Set [Tank]
    - The fifth and sixth of the 7 Spiral Mountain dungeons.
    - It requires no passes.
- [Void Space](https://digitalmastersworld.wiki.gg/Void_Space)
  	- **Recommended Gear**: Ring of the Marine Dragon + Necklace of the Wooden Puppet + Earring of the Metallic Beast + Bracelet of the Cruel Clown + Advanced True Digivice [SK]/Uncontrollable Rage D-Ark [AA]/ChromeDigizoid D-Ark [Tank]
    - **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Digital Hazard Clothing Set [Tank]
    - The seventh of the 7 Spiral Mountain dungeons.
    - It requires no passes. 
- [Fanglongmon Dungeon (Hard)](https://digitalmastersworld.wiki.gg/Fanglongmon_Dungeon_(Hard)) (FDGH)
  	- **Recommended Gear**: Ring of the Marine Dragon + Necklace of the Wooden Puppet + Corrupted Earring of the Metallic Beast + Bracelet of the Cruel Clown + Void Digivice [SK/AA/Tank]
    - **Recommended Clothing:** Vajramon's Warrior Clothing [AA DPS]/NightSky Clothing Set [SK DPS]/Digital Hazard Clothing Set [Tank]
...
2. Ancient Connections
	- Compared to Catalyst Kin and Throne of Ruin, Ancient Connections is much easier to obtain as it's all evolutions that only require Evoluters to unlock and on farmable eggs. The hardest digi to obtain, Gammamon, is obtainable via the Novice Exchange.
3. **\<Early Game Requirement>** Omega
	- Omega is an extremely easy deck to obtain, requiring only one cash shop exclusive digimon, Omegamon Alter-S. However, due to Berserker Arena, the Beta item necessary to unlock the digi on Gabumon and the eggs themselves are very cheap to buy from the player market.
